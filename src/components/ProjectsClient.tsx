...
export function ProjectsClient({ projects: initialProjects, displayLimit }: { projects: any[], displayLimit?: number }) {
    ...
    useEffect(() => {
        setCards(initialProjects.map((item: any) => ({
            ...item,
                                ...
                                <div className="flex flex-col flex-grow overflow-hidden">
                                    ...
                                    >
                                        ...
                                        {active.longDescription && (
                                            <p className="text-sm md:text-base leading-relaxed">{active.longDescription}</p>
                                        )}

                                        {/* Bullet Points */}
                                        {active.bulletPoints && active.bulletPoints.length > 0 && (
                                            <ul className="list-none ml-4 flex flex-col gap-2">
                                                {active.bulletPoints.map((point: string, idx: number) => (
                                                    <li key={idx} className="text-sm md:text-base leading-relaxed flex items-center gap-2">
                                        ...
                                        {active.techStack && active.techStack.length > 0 && (
                                            <div>
                                                <h4 className="font-semibold text-neutral-300 mb-2">Tech Stack:</h4>
                                                <div className="flex flex-wrap gap-2">
                                                    {active.techStack.map((tech: { name: string; icon: string }, idx: number) => (
                        ...
                        return (
                            ...
                            >
                                <CardContainer className="inter-var py-0">
                                    <div
                                        className="w-full h-full rounded-xl relative group"
                                    >
                                            ...
                                            <div className="relative z-10">
                                                ...
                                                <div className="flex justify-between items-center mt-6">
                                                    ...
                                                    <CardItem
                                                        ...
                                                        translateX={40}
                                                        as="button"
                                                        onClick={(e: React.MouseEvent) => { e.stopPropagation(); setActive(card); }}
