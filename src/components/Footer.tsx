    ...
    <footer className="w-full pt-16 pb-4 px-4 md:px-12 lg:px-24 bg-gradient-to-b from-black to-purple-950 text-white font-sans  shadow-[0_0_40px_0_rgba(168,85,247,0.10)] relative overflow-hidden">
        ...
        <div className="flex-1 w-full grid grid-cols-2 md:flex md:flex-row md:justify-between gap-y-8 gap-x-4 mt-8 md:mt-0">
          ...
          <div className="mb-8 md:mb-0 min-w-[120px] flex-1">
            ...
            <ul className="space-y-1 font-mono text-sm md:text-xs">
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">X(TWITTER)</a></li>
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">INSTAGRAM</a></li>
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">BLUESKY</a></li>
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">LINKEDIN</a></li>
            </ul>
          </div>
          {/* PAGES */}
          <div className="mb-8 md:mb-0 min-w-[120px] flex-1">
            ...
            <ul className="space-y-1 font-mono text-sm md:text-xs">
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">HOME</a></li>
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">COLLECTION</a></li>
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">FAQ</a></li>
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">PRICING</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-1 mb-0 md:mb-0 min-w-[120px] flex-1">
            ...
            <ul className="space-y-1 font-mono text-sm md:text-xs">
              <li><a href="#" className="hover:underline text-purple-400/80 hover:text-purple-400 transition-colors">REACH  US</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row md:items-end md:justify-between mt-8">
        ...
        <div className="w-full md:w-auto order-2 md:order-1 flex flex-row justify-between md:justify-start items-center text-xs font-mono text-purple-400/80 gap-x-4 md:gap-x-16 mb-2 md:mb-0">
          <span>2025©</span>
          <a href="#" className="hover:underline hover:text-purple-400 transition-colors">PERMISSIONS & TERMS</a>
