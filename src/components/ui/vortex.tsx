...
export const Vortex = (props: VortexProps) => {
  ...
  const initParticle = useCallback((i: number) => {
    ...
    if (!canvas || !particleProps) return;
  ...
  }, [rangeY, baseTTL, rangeTTL, baseSpeed, rangeSpeed, baseRadius, rangeRadius, baseHue, rangeHue, randRange, rand]);
  ...
  }, [drawParticle, checkBounds, initParticle, noise3D, xOff, yOff, zOff, noiseSteps, TAU]);
  ...
  return (
    <div className={cn("relative h-full w-full", props.containerClassName)}>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        ref={containerRef}
        className="absolute h-full w-full inset-0 z-0 bg-transparent flex items-center justify-center -translate-y-20"
      >
