  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-950 via-black to-black">
      ...
      <main className="flex-1 flex flex-col justify-center items-center w-full px-4 py-16">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-purple-400 mb-4">Blog Post Not Found</h2>
        ...
        <Link href="/blog" className="inline-block px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-lg font-semibold shadow-md hover:from-purple-600 hover:to-purple-800 transition-all">
          Go to Blog Home
        </Link>
      </main>
    </div>
